...
　　<li class="nav-item"><a href="{{ route('favorites.get_favorites', ['id' => $user->id]) }}" class="nav-link {{ Request::is('microposts/*/get_favorite') ? 'active' : '' }}">Favorite <span class="badge badge-secondary">{{ $count_favorites }}</span></a></li>    
